...
goto okJavaHome
:gotJdkHome
rem if not exist "%JAVA_HOME%\jre\bin\java.exe" goto noJavaHome
...
"%EXECUTABLE%" //IS//%SERVICE_NAME% ^
    --Description "Apache Tomcat 7.0.59 Server - http://tomcat.apache.org/" ^
